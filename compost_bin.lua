...
local function update_nodebox(pos)
	if is_empty(pos) then
		swap_node(pos, "skytest:wood_barrel_empty")
	else
		swap_node(pos, "skytest:wood_barrel")
	end
end
...
minetest.register_node("skytest:wood_barrel_empty", {
...
minetest.register_node("skytest:wood_barrel", {
...
minetest.register_craft({
	output = "skytest:wood_barrel_empty",
	recipe = {
